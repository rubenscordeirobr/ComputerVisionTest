...
namespace CameraVision.Infrastructure.Migrations
{
    ...
    [Migration("20260904021428_RuleClassColors")]
    partial class RuleClassColors
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CameraVision.Core.Entities.AgentSuggestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("CameraVision.Core.Entities.SystemSettings", b =>
                {
                    ...
                    b.Property<bool>("WhatsAppAudioEnabled")
                        .HasColumnType("INTEGER");

                    b.Property<int>("WhatsAppAudioMaxSeconds")
                        .HasColumnType("INTEGER");

                    b.Property<int>("WhatsAppBotDefaultHours")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("WhatsAppWebhookUrl")
                        .IsRequired()
                        .HasColumnType("TEXT");

                    b.Property<string>("WhisperApiKey")
                        .IsRequired()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CameraVision.Core.Entities.WhatsAppCommandLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("IntentSource")
                        .HasMaxLength(20)
                        .HasColumnType("TEXT");
                    ...
                    b.Property<int>("TriggersAffected")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("SenderNumber", "ReceivedAt");

                    b.HasIndex("Status", "ReceivedAt");

                    b.ToTable("WhatsAppCommandLogs");
                });
            ...
            modelBuilder.Entity("CameraVision.Core.Entities.AgentSuggestion", b =>
                {
                    b.HasOne("CameraVision.Core.Entities.WhatsAppCommandLog", null)
                        .WithMany()
